        ...
        <Container maxWidth="md" className="text-center">
          ...
          <Box className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4">
            <Button
              color="inherit"
              onClick={() => navigate("/login")}
              className="flex items-center space-x-2 px-6 py-3 bg-[#111A50] hover:bg-[#080D2B] text-white rounded-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              sx={{ border: "none" }}
            >
