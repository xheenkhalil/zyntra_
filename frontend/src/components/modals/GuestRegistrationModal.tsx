      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-[#1A1F91] rounded-lg flex items-center justify-center">
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 bg-[#1A1F91] rounded-full flex items-center justify-center mx-auto mb-4 success-animation">
        ...
        <div className="bg-[#1A1F91] rounded-lg p-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 mt-6">
          ...
          <button
            ...
            className="flex-1 px-4 py-3 bg-[#1A1F91] hover:bg-[#1A1F91] text-white rounded-lg font-semibold"
          >
            Create Account
          </button>
        </div>
