  ...
  return (
    <Box className="flex bg-gray-50 min-h-screen">
      ...
      <Box
        id="sidebar"
        component="aside"
        className={`fixed left-0 top-0 h-full bg-[#111A50] text-white shadow-2xl transition-all duration-300 z-40 ${isCollapsed ? 'sidebar-collapsed lg:w-20' : 'sidebar-expanded lg:w-64'
      ...
      >
        ...
        <Box className="flex items-center justify-between p-4 border-b border-blue-700">
          <Box className="flex items-center space-x-3">
            <Box className="w-8 h-8 bg-[#111A50] rounded-lg flex items-center justify-center flex-shrink-0">
