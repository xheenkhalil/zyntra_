        ...
        >
          ...
          >
            <Box className="flex items-center space-x-2">
              <Box className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-blue-900 to-blue-600 rounded-lg flex items-center justify-center">
                <FaGraduationCap className="text-white text-lg md:text-xl" />
              </Box>
              <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-900 to-blue-600 bg-clip-text text-transparent">
                ZYNTRA
              </span>
            </Box>
          </Box>
          ...
          <Box className="hidden md:flex items-center space-x-2 lg:space-x-3">
            ...
            <Button
              ...
              onClick={() => handleNavigate("/login")}
              className="flex items-center space-x-2 px-3 md:px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
        ...
        <Box className="lg:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-4">
          ...
          <Box className="flex flex-col space-y-2 pt-4 border-t border-gray-100">
            ...
            <Button
              color="inherit"
              onClick={() => handleNavigate("/login")}
              className="flex items-center justify-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg font-medium"
              startIcon={<FaUserPlus className="text-sm" />}
            >
              Create Account
            </Button>
