...
exports.getPublicQuizById = getPublicQuizById;
// ============================================================
// 3️⃣ SUBMIT QUIZ ANSWERS + STORE SCORE & OPTIONAL RATING
// ============================================================
const submitPublicQuiz = async (req, res) => {
    const { quizId } = req.params;
...
exports.submitPublicQuiz = submitPublicQuiz;
// ============================================================
// 4️⃣ UPDATE QUIZ RATING (Fixed version – safe insert)
// ============================================================
const updateQuizRating = async (req, res) => {
    const { quizId } = req.params;
...
exports.updateQuizRating = updateQuizRating;
